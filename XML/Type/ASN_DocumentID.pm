...
package Edge::B2B::XML::Type::ASN_DocumentID;


our @ISA=qw(XML::Pastor::Builtin::token);

Edge::B2B::XML::Type::ASN_DocumentID->XmlSchemaType( bless( {
...
B<Edge::B2B::XML::Type::ASN_DocumentID>  -  A class generated by L<XML::Pastor> . 
