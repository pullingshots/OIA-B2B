...
package Edge::B2B::XML::Type::Address_Country;


our @ISA=qw(XML::Pastor::Builtin::token);

Edge::B2B::XML::Type::Address_Country->XmlSchemaType( bless( {
...
B<Edge::B2B::XML::Type::Address_Country>  -  A class generated by L<XML::Pastor> . 
