...
package Edge::B2B::XML::Type::BaseCatalog_CatalogDescription;


our @ISA=qw(XML::Pastor::Builtin::token);

Edge::B2B::XML::Type::BaseCatalog_CatalogDescription->XmlSchemaType( bless( {
                 ...
                 'minLength' => '1',
                 'name' => 'BaseCatalog_CatalogDescription',
...
B<Edge::B2B::XML::Type::BaseCatalog_CatalogDescription>  -  A class generated by L<XML::Pastor> . 
