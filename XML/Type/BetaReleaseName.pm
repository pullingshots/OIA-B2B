...
package Edge::B2B::XML::Type::BetaReleaseName;


our @ISA=qw(XML::Pastor::Builtin::token);

Edge::B2B::XML::Type::BetaReleaseName->XmlSchemaType( bless( {
                 ...
                 'documentation' => bless( [
                                             bless( {
                                                      'text' => 'Optional designation for beta development'
...
B<Edge::B2B::XML::Type::BetaReleaseName>  -  A class generated by L<XML::Pastor> . 


=head1 DESCRIPTION

Optional designation for beta development
