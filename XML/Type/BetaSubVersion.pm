...
package Edge::B2B::XML::Type::BetaSubVersion;


our @ISA=qw(XML::Pastor::Builtin::integer);

Edge::B2B::XML::Type::BetaSubVersion->XmlSchemaType( bless( {
...
B<Edge::B2B::XML::Type::BetaSubVersion>  -  A class generated by L<XML::Pastor> . 
