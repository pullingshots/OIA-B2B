...
package Edge::B2B::XML::Type::Catalog_Products_LineItem_ExtendedInfo_RGBColor;


our @ISA=qw(XML::Pastor::Builtin::token);

Edge::B2B::XML::Type::Catalog_Products_LineItem_ExtendedInfo_RGBColor->XmlSchemaType( bless( {
                 ...
                 'name' => 'Catalog_Products_LineItem_ExtendedInfo_RGBColor',
...
B<Edge::B2B::XML::Type::Catalog_Products_LineItem_ExtendedInfo_RGBColor>  -  A class generated by L<XML::Pastor> . 
