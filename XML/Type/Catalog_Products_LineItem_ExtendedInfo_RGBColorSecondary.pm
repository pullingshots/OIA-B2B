...
package Edge::B2B::XML::Type::Catalog_Products_LineItem_ExtendedInfo_RGBColorSecondary;


our @ISA=qw(XML::Pastor::Builtin::token);

Edge::B2B::XML::Type::Catalog_Products_LineItem_ExtendedInfo_RGBColorSecondary->XmlSchemaType( bless( {
                 ...
                 'name' => 'Catalog_Products_LineItem_ExtendedInfo_RGBColorSecondary',
...
B<Edge::B2B::XML::Type::Catalog_Products_LineItem_ExtendedInfo_RGBColorSecondary>  -  A class generated by L<XML::Pastor> . 
