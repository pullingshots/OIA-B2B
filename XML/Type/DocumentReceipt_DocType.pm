...
package Edge::B2B::XML::Type::DocumentReceipt_DocType;


our @ISA=qw(XML::Pastor::Builtin::token);

Edge::B2B::XML::Type::DocumentReceipt_DocType->XmlSchemaType( bless( {
...
B<Edge::B2B::XML::Type::DocumentReceipt_DocType>  -  A class generated by L<XML::Pastor> . 
