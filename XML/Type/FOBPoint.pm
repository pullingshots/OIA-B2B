...
package Edge::B2B::XML::Type::FOBPoint;


our @ISA=qw(XML::Pastor::Builtin::token);

Edge::B2B::XML::Type::FOBPoint->XmlSchemaType( bless( {
...
B<Edge::B2B::XML::Type::FOBPoint>  -  A class generated by L<XML::Pastor> . 
