...
package Edge::B2B::XML::Type::FreightBillingMethod;


our @ISA=qw(XML::Pastor::Builtin::token);

Edge::B2B::XML::Type::FreightBillingMethod->XmlSchemaType( bless( {
...
B<Edge::B2B::XML::Type::FreightBillingMethod>  -  A class generated by L<XML::Pastor> . 
