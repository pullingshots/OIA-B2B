...
package Edge::B2B::XML::Type::Invoice_Products_LineItem;
...
Edge::B2B::XML::Type::Invoice_Products_LineItem->mk_accessors( qw(Quantity UnitPrice LineNumber LineComment));

Edge::B2B::XML::Type::Invoice_Products_LineItem->XmlSchemaType( bless( {
                 'attributeInfo' => {},
                 'attributePrefix' => '_',
                 'attributes' => [],
                 ...
                 'isRedefinable' => 1,
                 'metaClass' => 'Edge::B2B::XML::Pastor::Meta',
                 'name' => 'Invoice_Products_LineItem',
...
B<Edge::B2B::XML::Type::Invoice_Products_LineItem>  -  A class generated by L<XML::Pastor> . 
