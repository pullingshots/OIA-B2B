...
package Edge::B2B::XML::Type::MajorVersion;


our @ISA=qw(XML::Pastor::Builtin::integer);

Edge::B2B::XML::Type::MajorVersion->XmlSchemaType( bless( {
...
B<Edge::B2B::XML::Type::MajorVersion>  -  A class generated by L<XML::Pastor> . 
