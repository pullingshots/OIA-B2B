...
package Edge::B2B::XML::Type::PO_CCPayment_CCSecurityCode;


our @ISA=qw(XML::Pastor::Builtin::token);

Edge::B2B::XML::Type::PO_CCPayment_CCSecurityCode->XmlSchemaType( bless( {
                 ...
                 'name' => 'PO_CCPayment_CCSecurityCode',
...
B<Edge::B2B::XML::Type::PO_CCPayment_CCSecurityCode>  -  A class generated by L<XML::Pastor> . 
