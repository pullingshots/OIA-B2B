...
package Edge::B2B::XML::Type::ResponseText;


our @ISA=qw(XML::Pastor::Builtin::token);

Edge::B2B::XML::Type::ResponseText->XmlSchemaType( bless( {
                 ...
                 'enumeration' => {
                                    ...
                                    'Contact Vendor' => 1,
                                    'Document Not Supported' => 1,
                                    'Duplicate Document' => 1,
                                    'Missing or Incorrect Data' => 1,
                                    'Rule Violation' => 1,
                                    'Schema Non-Validation' => 1,
...
B<Edge::B2B::XML::Type::ResponseText>  -  A class generated by L<XML::Pastor> . 
