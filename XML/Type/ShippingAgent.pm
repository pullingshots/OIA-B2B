...
package Edge::B2B::XML::Type::ShippingAgent;


our @ISA=qw(XML::Pastor::Builtin::token);

Edge::B2B::XML::Type::ShippingAgent->XmlSchemaType( bless( {
...
B<Edge::B2B::XML::Type::ShippingAgent>  -  A class generated by L<XML::Pastor> . 
